...
- **Satire**
	...
	4. **Privacy settings**: a tongue-in-cheek puzzle slash whack-a-mole mini-game about turning off privacy-invasive features.

The mascot AI was inspired by late 90s virtual assistants such as Microsoft's Clippy and the freeware, later convicted spyware, BonziBuddy. In addition of making the experience more engaging, the alternate reality of AI being bundled with late 90s virtual mascots affords the player a certain comedic distance from reality which might help them view the situation with new eyes, as well as using Bonzi's iconically annoying voice as an added layer of annoyance to the AI.
